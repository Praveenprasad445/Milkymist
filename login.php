                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.php"><p style="color:rgba(255, 255, 255, 1);
font-family:Poppins,sans-serif;
font-size:18px;
font-weight:500;
text-transform:capitalize;">Home</p></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <span class="breadcrumb-item active"><p style="color:rgba(255, 255, 255, 1);
font-family:Poppins,sans-serif;
font-size:18px;
font-weight:500;
text-transform:capitalize;">Login/Register</p></span>
                                </nav>
                            </div>
                        </div>
                    </div>
